...
void display_queue(){
    ...
    cout << "--------------------------------------------------------------------------" << endl;
    for(int i = front; i <= rear; i++){
        cout << "Posisi " << (i - front + 1) << ": Nama: " << queue[i].nama_penumpang 
             << ", Rute: " << queue[i].rute_yang_dipilih 
             << ", Harga: Rp " << queue[i].harga_tiket_pesanan << endl;
    }
    cout << "--------------------------------------------------------------------------" << endl;
}
...
Transaksi pop(){
    if(top < 0){
        ...
        top--;
        cout << "Transaksi terakhir (" << value.nama_penumpang << ", Rute: " << value.rute_kereta 
             << ", Harga: Rp " << value.harga_transaksi << ") dihapus dari riwayat." << endl;
        return value;
    }
}
...
void display_stack(){
    ...
    cout << "----------------------------------------------------------------------------------------" << endl;
    for(int i = top; i >= 0; i--){
        cout << "Posisi " << (top - i + 1) << ": Nama: " << stack[i].nama_penumpang 
             << ", Rute: " << stack[i].rute_kereta 
             << ", Harga: Rp " << stack[i].harga_transaksi 
             << ", Waktu: " << stack[i].waktu_transaksi << endl;
    }
    cout << "----------------------------------------------------------------------------------------" << endl;
}
...
void hapusKereta(Kereta* arr, int& n) {
    ...
    cin >> konfirmasi;
    clearInputBuffer(); // Membersihkan buffer setelah cin
...
int main() {
    ...
    while(pilihan != "0") {
        ...
        cout << "7) Update data kereta" << endl;
        cout << "8) Hapus data kereta" << endl;
        cout << "9) Tambah Penumpang ke Antrian Pembelian Tiket (Queue)" << endl;
        cout << "10) Proses Tiket (Dequeue)" << endl;
        cout << "11) Riwayat Transaksi (Stack)" << endl;
        cout << "12) Batalkan Transaksi Terakhir (Pop)" << endl;
        cout << "13) Tampil semua antrian" << endl;
        cout << "14) Tampil semua riwayat" << endl;
        ...
        if(pilihan == "1") {
            ...
            tampilJadwal(kereta, jumlah_kereta);
            pause();
        } else if(pilihan == "7") { // Update Kereta
            cls();
            updateKereta(kereta, jumlah_kereta);
            pause();
        } else if(pilihan == "8") { // Hapus Kereta
            cls();
            hapusKereta(kereta, jumlah_kereta);
            pause();
        } else if(pilihan == "9") { // Enqueue
            cls();
            if (jumlah_kereta == 0) {
            ...
            pause();
        } else if(pilihan == "10") { // Dequeue dan Push ke Stack
            cls();
            ...
            pause();
        } else if(pilihan == "11") { // Tampil Stack
            cls();
            display_stack();
            pause();
        } else if(pilihan == "12") { // Pop Stack
            cls();
            pop();
            pause();
        } else if(pilihan == "13") { // Tampil Queue
            cls();
            display_queue();
            pause();
        } else if(pilihan == "14") { // Tampil Stack
            cls();
            display_stack();
            pause();
        } else if(pilihan == "0") {
